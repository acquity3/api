...
def test_get_chats_by_user_id():
    ...
    assert archived_chat_room_offer == res_archived_chat_room["pending_offer"]
    ...
    assert unarchived_chat_rooms[chat_room1["id"]]["pending_offer"] is None
    ...
    assert unarchived_chat_rooms[chat_room2["id"]]["pending_offer"] is None
